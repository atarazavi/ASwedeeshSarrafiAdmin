...
const AreaChartWidget = Loadable({
   loader: () => import("./AreaChartWidget"),
   loading: MyLoadingComponent
})

const RecentTransferRates = Loadable({
   loader: () => import("./RecentTransferRates"),
   loading: MyLoadingComponent
})

const CurrentBalance = Loadable({
   loader: () => import("./CurrentBalance"),
   loading: MyLoadingComponent
})

const RequestExpirationcountDown = Loadable({
   loader: () => import("./RequestExpirationcountDown"),
   loading: MyLoadingComponent
})
